#!/usr/bin/env python3
"""GraspNet API evaluation on the EXACT sampled frame schedule of E1/E2."""
...
def main():
    ...
    p.add_argument('--methods', default='native,model')
    ...
    for method in args.methods.split(','):
        ...
        for case in protocol['cases']:
            ...
            with lock(out/'.run.lock'):
                ...
                print(f'[E1E2 AP] {method} {case} {args.split}: {ap}', flush=True)
