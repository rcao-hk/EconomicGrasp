...
GPUS="${GPUS:-0,1,2}"
OUTPUT_ROOT="${OUTPUT_ROOT:-/data2/robotarm/result/grasp/rgbgrasp/log/p5_v11_repair_10pct}"
...
# Serialized only. P5-v1.1 training explicitly alternates native/corrupt batches.
P5_CORRUPT_PROB="${P5_CORRUPT_PROB:-0.5}"
...
# P5-v1.1 additions.
P5V11_SAFE_RADIUS_M="${P5V11_SAFE_RADIUS_M:-0.005}"
P5V11_SAFE_IDENTITY_WEIGHT="${P5V11_SAFE_IDENTITY_WEIGHT:-1.0}"
P5V11_VAL_CORRUPT_SEED="${P5V11_VAL_CORRUPT_SEED:-55117}"
...
echo "[P5-v1.1] 50/50 native-corrupt batches; safe radius=${P5V11_SAFE_RADIUS_M} m"
torchrun --standalone --nproc_per_node="${NPROC}" train_p5_v11.py \
  ...
  --p5v11_safe_radius_m "${P5V11_SAFE_RADIUS_M}" \
  --p5v11_safe_identity_weight "${P5V11_SAFE_IDENTITY_WEIGHT}" \
  --p5v11_val_corrupt_seed "${P5V11_VAL_CORRUPT_SEED}"
